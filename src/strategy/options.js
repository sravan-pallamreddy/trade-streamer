...
const OPTION_CONFIG = {
  ...
  AMAT: { multiplier: 100, strikeIncrement: 1, supports0DTE: false, defaultOTMPct: 0.01 },
  GS: { multiplier: 100, strikeIncrement: 2.5, supports0DTE: false, defaultOTMPct: 0.01 },
